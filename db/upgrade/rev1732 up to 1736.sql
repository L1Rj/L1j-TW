...
alter table characters add  `OriginalCha` int(3) default '0';
alter table characters add  `OriginalInt` int(3) default '0';
alter table characters add  `OriginalWis` int(3) default '0';