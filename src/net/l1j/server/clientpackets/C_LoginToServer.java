...
import static net.l1j.server.skills.SkillId.COOKING_1_0_N;
import static net.l1j.server.skills.SkillId.COOKING_1_0_S;
import static net.l1j.server.skills.SkillId.COOKING_1_6_N;
import static net.l1j.server.skills.SkillId.COOKING_1_6_S;
import static net.l1j.server.skills.SkillId.COOKING_2_0_N;
import static net.l1j.server.skills.SkillId.COOKING_2_0_S;
import static net.l1j.server.skills.SkillId.COOKING_2_6_N;
import static net.l1j.server.skills.SkillId.COOKING_2_6_S;
import static net.l1j.server.skills.SkillId.COOKING_3_0_N;
import static net.l1j.server.skills.SkillId.COOKING_3_0_S;
import static net.l1j.server.skills.SkillId.COOKING_3_6_N;
import static net.l1j.server.skills.SkillId.COOKING_3_6_S;
...
import static net.l1j.server.skills.SkillId.GMSTATUS_CRAZY;
