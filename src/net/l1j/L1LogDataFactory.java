	...
	public L1LogDataFactory() throws SQLException {
		...
		if (!fileex) {
			...
			try {
				...
				stmt.executeUpdate("CREATE TABLE LogDropItem (Time Timestamp, Ip Varchar, Account Varchar, CharId Int, CharName Varchar, ObjectId Int, ItemName Varchar, EnchantLevel Int, TargetName Varchar, DropCount Int);");
