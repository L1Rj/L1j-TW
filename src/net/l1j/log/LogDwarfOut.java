...
public class LogDwarfOut {
	...
	public void storeLogDwarfOut(L1PcInstance pc, L1ItemInstance item, int item_count_before, int item_count_after, int item_out_count) {
		Connection con = null;
		PreparedStatement pstm = null;
		try {
			con = L1LogDataFactory.getInstance().getConnection();
			pstm = con.prepareStatement("INSERT INTO LogWareHouseOut VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
			Date time = new Date();
