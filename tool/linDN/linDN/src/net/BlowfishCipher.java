...
public class BlowfishCipher
{
	...
	public static long[] blowfish_init(long[] keys)
	{
		...
		byte[] key = UByte8.fromArray(keys);
	...
	{
		byte[] c = UByte8.fromULong32(x);
		int rtmp = (int) S[0][c[3] & 0xFF] + (int) S[1][c[2] & 0xFF];
		long rtmp2 = rtmp ^ S[2][c[1] & 0xFF];
		int rtmp3 = (int) rtmp2 + (int) S[3][c[0] & 0xFF];
		return rtmp3;
	}
